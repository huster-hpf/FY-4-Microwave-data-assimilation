function TA_noiseless = Real_Antenna_conv(TB,angle_x,angle_y,sample_width_x,sample_width_y,N_x,N_y,Antenna_Pattern,Coordinate_x_old,Coordinate_y_old)
%   函数功能：模拟辐射计载荷扫描观测成像
%  
%   输入参数:
%    TB             : 场景高分辨率亮温图像
...
AP_Coordinate_Long = linspace(-angle_y,angle_y-d_Long,2*N_x+1);
AP_Coordinate_Lat = linspace(-angle_x,angle_x-d_Lat,2*N_y+1);
[Antenna_Pattern_Full] = Antenna_pattern_2D_transform(Antenna_Pattern,Coordinate_x_old,Coordinate_y_old,AP_Coordinate_Long,AP_Coordinate_Lat);
