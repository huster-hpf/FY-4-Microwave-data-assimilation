...
file_path = 'D:\当前的工作\2015.03.21 基于资料同化的GEO仿真研究\01. 仿真亮温数据\2016.09.30 飓风彩虹rainbow-GFS-20151002\亮温图像';   %文件存储目录 
TB_filename = 'HurricanRainbow_03_06_C37_H.mat';     %亮温图像文件名，该场景范围为1500*1500公里
...
if strcmpi('C',TB_filename(length_filename-7))
     freq_index = str2double(TB_filename(length_filename-6));     
else
     freq_index = str2double([TB_filename(length_filename-7),TB_filename(length_filename-6)]);     
end
%part1：end**************************************************************************************************************************************************
...
[RMSE_real,norm_RMSE_real] = Root_Mean_Square_Error(TB,TA_real,MSE_offset,0);
[RMSE,norm_RMSE] = Root_Mean_Square_Error(TB,TA,MSE_offset,0);
[RMSE_BG,norm_RMSE_BG] = Root_Mean_Square_Error(TB,TA_BG,MSE_offset,0);
[RMSE_real_BG,norm_RMSE_real_BG] = Root_Mean_Square_Error(TB,TA_real_BG,MSE_offset,0);
