...
observation_path = 'C:\Users\国子监祭酒\Desktop\亮温和坐标文件\极轨\观测数据';   %观测数据存储目录
file_path = 'C:\Users\国子监祭酒\Desktop\亮温和坐标文件\极轨\正演仿真亮温';   %正演仿真亮温文件存储目录
satellite_payload = 'ATMS';                         %设置载荷名称
orbit_height = 824;                                 %设置载荷轨道高度, unit:km  ATMS：824km ， 风云三号：836km
observation_time = '2016-7-7-4：42：1-4：50：0'; %载荷观测亮温数据时间
scene_time = '2016-7-07_04_45_00';               %场景正演亮温数据时间
background_time = '2016-7-07_04_45_00';          %场景插值亮温数据时间
channel_start_index = 1;                            %设置亮温数据的频率通道编号起始
channel_end_index = 1;                             %设置亮温数据的频率通道编号终止 ATMS-22； FY3C_MWTS-13； FY3C-MWHTS-15；FY3B-MWTS-4；FY3B-MWHS-5
...
%     observation_lati_long=sprintf('%s\\coords.mat',observation_path);
    load(observation_matfile);
%     load(observation_lati_long);
    %读取观测亮温数据，包含Long、Lat、TB三个矩阵
    %载荷观测数据的经纬度坐标范围
...
%% 以下是每个频点都不一样的辐射计载荷参数
    if (strcmpi('ATMS',satellite_payload)) 
        ...
        if (strcmpi('AMSU',satellite_payload)) 
        switch freq_channel%中心频率,     %带宽, 单位:Hz       %噪声系数,单位:dB   %天线口径，单位：米
             case 1, freq= 23.8e9;   bandwith = 270e6;    noise_figure= 4.5;antenna_diameter = 0.275; integral_time = 18*10^(-3);  
             case 2, freq= 31.4e9;   bandwith = 180e6;    noise_figure= 5;  antenna_diameter = 0.215; integral_time = 18*10^(-3);  
             case 3, freq= 50.3e9;   bandwith = 180e6;    noise_figure= 6;  antenna_diameter = 0.125; integral_time = 18*10^(-3);               
             case 4, freq= 52.8e9;   bandwith = 400e6;    noise_figure= 6;  antenna_diameter = 0.125; 
             case 5, freq= 53.596e9; bandwith = 2*170e6;  noise_figure= 6;  antenna_diameter = 0.125; 
             case 6, freq= 54.4e9;   bandwith = 400e6;    noise_figure= 6;  antenna_diameter = 0.125; 
             case 7, freq= 54.94e9;  bandwith = 400e6;    noise_figure= 6;  antenna_diameter = 0.125; 
             case 8, freq= 55.5e9;   bandwith = 330e6;    noise_figure= 6;  antenna_diameter = 0.125; 
             case 9, freq= 57.29e9;  bandwith = 2*155e6;  noise_figure= 6;  antenna_diameter = 0.125; 
             case 10,freq= 57.507e9; bandwith = 2*78e6;   noise_figure= 6;  antenna_diameter = 0.125; 
             case 11,freq= 57.66e9;  bandwith = 2*36e6;   noise_figure= 6;  antenna_diameter = 0.125; 
             case 12,freq= 57.63e9;  bandwith = 2*16e6;   noise_figure= 6;  antenna_diameter = 0.125; 
             case 13,freq= 57.62e9;  bandwith = 2*8e6;    noise_figure= 6;  antenna_diameter = 0.125; 
             case 14,freq= 57.617e9; bandwith = 2*3e6;    noise_figure= 6;  antenna_diameter = 0.125; 
             case 15,freq= 89.0e9;   bandwith = 2000e6;   noise_figure= 9;  antenna_diameter = 0.11; 
             case 16,freq= 89.0e9;   bandwith = 2000e6;   noise_figure= 9;  antenna_diameter = 0.11;
             case 17,freq= 157.0e9;  bandwith = 2*1150e6; noise_figure= 12; antenna_diameter = 0.11;
             case 18,freq= 190.31e9; bandwith = 2*2000e6; noise_figure= 12; antenna_diameter = 0.11;
             case 19,freq= 187.81e9; bandwith = 2*2000e6; noise_figure= 12; antenna_diameter = 0.11;
             case 20,freq= 186.31e9; bandwith = 2*1000e6; noise_figure= 12; antenna_diameter = 0.11;
             case 21,freq= 185.11e9; bandwith = 2*1000e6; noise_figure= 12; antenna_diameter = 0.11;
