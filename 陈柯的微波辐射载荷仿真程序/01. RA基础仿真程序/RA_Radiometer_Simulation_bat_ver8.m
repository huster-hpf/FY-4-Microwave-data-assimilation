...
for freq_index = [1,[3:8],[10:13]],
     %TB_filename = sprintf('C%s_%s.mat', num2str(freq_index),scene_time); %亮温图像文件名
     TB_filename = sprintf('%s_C%s_H',scene_name,num2str(freq_index));
...
%              case 22,freq= 184.31e9; bandwith = 2*500e6;  noise_figure= 12; antenna_diameter = 0.11;  integral_time = 18*10^(-3);
             ...
             case 1, freq= 50.3e9;   bandwith = 180e6;    noise_figure= 3;  antenna_diameter = 5;                      
             case 2, freq= 51.76e9;  bandwith = 400e6;    noise_figure= 3;  antenna_diameter = 5;                     
             case 3, freq= 52.8e9;   bandwith = 400e6;    noise_figure= 3;  antenna_diameter = 5;                     
             case 4, freq= 53.596e9; bandwith = 400e6;    noise_figure= 3;  antenna_diameter = 5;                     
             case 5, freq= 54.4e9;   bandwith = 400e6;    noise_figure= 3;  antenna_diameter = 5;                     
             case 6, freq= 54.94e9;  bandwith = 400e6;    noise_figure= 3;  antenna_diameter = 5;                      
             case 7, freq= 55.5e9;   bandwith = 330e6;    noise_figure= 3;  antenna_diameter = 5;                     
             case 8, freq= 57.29e9;  bandwith = 330e6;    noise_figure= 3;  antenna_diameter = 5; 
             case 9, freq= 57.507e9; bandwith = 2*78e6;   noise_figure= 3;  antenna_diameter = 5; 
             case 10,freq= 57.66e9;  bandwith = 4*36e6;   noise_figure= 3;  antenna_diameter = 5; 
             case 11,freq= 57.63e9;  bandwith = 4*16e6;   noise_figure= 3;  antenna_diameter = 5; 
             case 12,freq= 57.62e9;  bandwith = 4*8e6;    noise_figure= 3;  antenna_diameter = 5; 
             case 13,freq= 57.617e9; bandwith = 4*3e6;    noise_figure= 3;  antenna_diameter = 5; 
