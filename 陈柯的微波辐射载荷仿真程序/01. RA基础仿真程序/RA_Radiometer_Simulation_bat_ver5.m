...
if  flag_Resolution_Enhancement == 1;
    ...
    case 'SIR'
         Block_num = 6;       %横纵分块数量
         [TA_RE,factor_opt] = split_deconv_SIR(TA,TB,Block_num,sample_width_Lat,sample_width_Long,sample_factor,Ba,illumination_taper,angle_Long,angle_Lat,d_Long,d_Lat);
