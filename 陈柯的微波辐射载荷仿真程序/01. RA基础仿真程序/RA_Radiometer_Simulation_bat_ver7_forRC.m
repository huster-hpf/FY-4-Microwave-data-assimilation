...
file_path = 'F:\模拟观测亮温\奥鹿TbMap\正演亮温';   %文件存储目录
file_path1='F:\模拟观测亮温\奥鹿TbMap\坐标文件';
%计算场景在经度和纬度方向的观测角范围
...
%        save(['..\05. RA仿真结果\' MatFileName],'TA_noiseless','TA','Antenna_Pattern','NEDT','HPBW','SLL','MBE','RMSE','Corr_coefficient','ground_resolution');
       save(['F:\模拟观测亮温\奥鹿TbMap\模拟观测亮温\' FileName],'TA_noiseless','TA','Antenna_Pattern','NEDT','HPBW','SLL','MBE','RMSE','Corr_coefficient','ground_resolution');
       if  flag_Resolution_Enhancement == 1;
%            save(['..\05. RA仿真结果\' MatFileName],'TA_RE','RMSE_RE','Corr_coefficient_RE','factor_opt','-append'); 
           save(['F:\模拟观测亮温\奥鹿TbMap\模拟观测亮温\' FileName],'TA_RE','RMSE_RE','Corr_coefficient_RE','factor_opt','-append');
       end
    end   
   %给所有channel仿真结果列表赋值
