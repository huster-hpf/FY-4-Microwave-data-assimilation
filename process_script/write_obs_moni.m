function write_obs_moni( time,num_lat,num_lon,chan )
%edit by hongpengfei
%2018.11.10
...
for i=1:chan
    TB_dir='C:\Users\hust\Desktop\TA_RTTOV';
    TB_file=sprintf('%s\\GOES_GEM5_C%d_TyphoonMaria_08_12',TA_dir,i);
...
%创建文件夹
obs_dir=sprintf('F:\\obs_moni\\%s',time);
mkdir(obs_dir);
