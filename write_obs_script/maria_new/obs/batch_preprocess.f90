...
IMPLICIT NONE
  INTEGER    :: i,j
  CHARACTER(len=100) :: in_dir='/g3/hanwei/hpf/DOTLRT_obs_file/maria_new/fy4/TA_8db/'
  CHARACTER(len=100) :: out_dir='/g3/hanwei/hpf/write_obs_script/maria_Ruralizate_50km/obs/output/'
...
!       rad(iobs)%tbb           = 0
       ...
       rad(iobs)%tbb(15)        = tbb(iobs,15)
       rad(iobs)%tbb(16)        = tbb(iobs,16)
       rad(iobs)%tbb(17)        = tbb(iobs,17)
       rad(iobs)%tbb(18)        = tbb(iobs,18)
       rad(iobs)%tbb(19)        = tbb(iobs,19)
       rad(iobs)%tbb(20)        = tbb(iobs,20)
       rad(iobs)%tbb(21)        = tbb(iobs,21)
       rad(iobs)%tbb(22)        = tbb(iobs,22)
       rad(iobs)%tbb(23)        = tbb(iobs,23)
       rad(iobs)%tbb(24)        = tbb(iobs,24)
       rad(iobs)%tbb(25)        = tbb(iobs,25)
       rad(iobs)%tbb(26)        = tbb(iobs,26)
       rad(iobs)%tbb(27)        = tbb(iobs,27)
       rad(iobs)%tbb(28)        = tbb(iobs,28)
       rad(iobs)%tbb(29)        = tbb(iobs,29)
       rad(iobs)%tbb(30)        = tbb(iobs,30)
       rad(iobs)%tbb(31)        = tbb(iobs,31)
       rad(iobs)%tbb(32)        = tbb(iobs,32)
       rad(iobs)%tbb(33)        = tbb(iobs,33)
       rad(iobs)%tbb(34)        = tbb(iobs,34)
       rad(iobs)%tbb(35)        = tbb(iobs,35)
       rad(iobs)%tbb(36)        = tbb(iobs,36)
       rad(iobs)%tbb(37)        = tbb(iobs,37)
       rad(iobs)%tbb(38)        = tbb(iobs,38)
       rad(iobs)%tbb(39)        = tbb(iobs,39)
       rad(iobs)%tbb(40)        = tbb(iobs,40)
       rad(iobs)%tbb(41)        = tbb(iobs,41)
       rad(iobs)%tbb(42)        = tbb(iobs,42)
