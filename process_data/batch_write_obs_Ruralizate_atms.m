...
input_dir='/g3/hanwei/hpf/DOTLRT_TB/maria_new/atms';     %输入正演亮温位置
%input_dir='/g3/hanwei/hpf/DOTLRT_TA/maria_new/atms';     %输入正演亮温位置
%input_meteo_dir='D:\科研使我快乐\科研\maliya\大气参数';      %写观测资料必要的大气参数变量。
%output_dir='/g3/hanwei/hpf/DOTLRT_obs_file/maria_new/TA';     %写观测资料的输出文件夹
output_dir='/g3/hanwei/hpf/DOTLRT_obs_file/maria_new/atms/TB';     %写观测资料的输出文件夹
input_all_the_file_dir='/g3/hanwei/hpf/DOTLRT_TB/maria_new/all_the_same_file';    %写观测资料必要的大气共有的大气参数变量。
...
intput_need_file=sprintf('%s/all_the_same_file.mat',input_all_the_file_dir);   %写观测资料所需要的共同的变量文件
...
parfor i=1:simu_day
    for j=1:simu_hour
        ...
        time
%        write_TA_obs_Ruralizate_atms(time,num_lat,num_lon,obs_point,chan,input_dir,output_dir,scene_name);
        write_TB_obs_Ruralizate_atms(time,num_lat,num_lon,obs_point,chan,input_dir,output_dir,scene_name);
    end
end
